...
public class TheStack : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // transform.position = Vector3.MoveTowards(transform.position, desiredPosition, StackMovingSpeed * Time.deltaTime);
    ...
    bool Spawn_Block()
    {
        ...
        // 기준 사이즈 값에 따라 위치가 달라짐
        desiredPosition = new Vector3(0, -transform.localScale.y) * stackCount;
        blockTransition = 0f;
